CLASS zcl_ce_rap_agency_mik DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
 ...
 TYPES t_agency_range TYPE RANGE OF ZZ_TRAVEL_AGENCY_ES55173B5845B-agencyid.
    TYPES t_business_data TYPE TABLE OF ZZ_TRAVEL_AGENCY_ES55173B5845B.
...
CLASS zcl_ce_rap_agency_mik IMPLEMENTATION.
  ...
  METHOD get_agencies.
    ...
    service_consumption_name = to_upper( 'ZSC_RAP_AGENCY_mik' ).
